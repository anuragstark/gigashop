...
```bash
docker build -t anuragstark/gigashop-app:1 .
```

4. Build and run data migration:
```bash
# Build migration image
docker build -t anuragstark/gigashop-migration:1 -f scripts/Dockerfile.migration .
...
<div align="center">
  <p>
    Made with ❤️ by <a href="GigaShop.com" target="_blank"><b></b></a>
  </p>
</div>
