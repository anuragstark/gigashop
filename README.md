# 🛍️ GigaShop - Modern E-commerce Platform
...
GigaShop is a modern, full-stack e-commerce platform built with Next.js 14, TypeScript, and MongoDB. It features a beautiful UI with Tailwind CSS, secure authentication, real-time cart updates, and a seamless shopping experience.
...
GigaShop follows a three-tier architecture pattern:
...
```bash
git clone https://github.com/anuragstark/GigaShop
cd terraform
```
2. **Generate SSH Key Pair:**
Create a new SSH key to access your EC2 instance:
```bash
ssh-keygen -f gigashop-key
```
This will prompt you to create a new key file named gigashop-key.

3. **Private key permission:** Change your private key permission:
```bash
chmod 400 gigashop-key
```
...
```bash
ssh -i gigashop-key ubuntu@<public-ip>
```
...
> > - **SCM:** `Git`<br/>
> > - **Repository URL:** `https://github.com/<your user-name/gigashop-app`<br/>
...
>  -    **Namespace:**
 gigashop-app (or your desired namespace)
